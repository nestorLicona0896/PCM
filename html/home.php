            ...
            <div class="container-fluid  text-black text-center" id="header1">
                <div class="row row-cols-3 p-0 m-0" id="headerColumn">
                    <div class="col-md-4 col-12">
                        <img src="../imagenes/logo.png" alt="" width="400px" id="storeLogo">
                    </div>

                    <div class="col-md-4 col-12">
                        <img src="../imagenes/pcm.png" alt="" width="400px" id="storeName">
                        ...
                        <nav class="navbar navbar-expand navbar-light p-0">
                            <div class="collapse navbar-collapse" id="navbarNav">
                                ...
                                <ul class="navbar-nav" id="mainMenu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" id="login">Iniciar sesion</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
                                        ...
                                        <div class="grid-container">
                                            <div class="grid-item">
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="article">
                                                            <span class="new">Articulo nuevo</span>
                                            ...
                                            <div class="grid-item">
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="article">
                                                            <span class="new">Articulo nuevo</span>
                                                            <img src="../imagenes/video.png" class="product-img"> 
                                                            <h2>MSI rtx 3090  TI 24 GB Suprim X</h2>
                                                            <p class="price">₡99.999</p>  
                                                        </div>
                                                    </div>
                                                    <div class="item-body">
                                            ...
                                            <div class="grid-item">
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="article">
                                                            <span class="new">Articulo nuevo</span>
                                                            <img src="../imagenes/processor.png" class="product-img"> 
                                                            <h2>PROCESADOR INTEL® CORE™ I7-10700F 16 M, HASTA 4,80 GHZ</h2>
                                                            <p class="price">₡99.999</p>  
                                                        </div>
                                                    </div>
                                                    <div class="item-body">
                                            ...
                                            <div class="grid-item">
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="article">
                                                            <span class="new">Articulo nuevo</span>
                                                            <img src="../imagenes/motherboard.png" class="product-img"> 
                                                            <h2>MSI MEG Z490 GODLIKE Intel Socket 1200 Motherboard</h2>
                                                            <p class="price">₡99.999</p>  
                                                        </div>
                                                    </div>
                                                    <div class="item-body">
                                            ...
                                            <div class="grid-item">
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="article">
                                                            <span class="new">Articulo nuevo</span>
                                                            <img src="../imagenes/power.png" class="product-img"> 
                                                            <h2>FUENTE DE PODER XPG PYLON 650W, NEGRO (PYLON650B-BKCUS) CERTIFICADA</h2>
                                                            <p class="price">₡99.999</p>  
                                                        </div>
                                                    </div>
                                                    <div class="item-body">
